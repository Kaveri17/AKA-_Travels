...
import { getPopular, getProd } from "../api/Pop";
    ...
    <p className='rounded-lg bg-cyan-300 absolute left-10 top-10 text-white font-'>(2 Trips)</p>
            ...
            <Slider {...settings}>
              {
                ...
                <div className="border-2 border-orange-200 w-full">
                  ...
                  <div className=" flex flex-row justify-center my-8 ">
                    <div className="leftt">
                      <i class="bi bi-geo-alt">{product.product_location}</i>
                      <br />
      ...
      return <div >
                <div className="border-2 border-orange-200 w-full">
                  ...
                  <div className="flex flex-row justify-center my-8">
                    <div className="leftt">
                      <i className="bi bi-geo-alt">{product.product_location}</i>
                      <br />
                      <i className="bi bi-clock">4Days-2Nights</i>
                      <br />
                    </div>
                    <div className="righttt mx-3">
                      <div className="discountprice border-2  border-blue-500 bg-blue-200">
