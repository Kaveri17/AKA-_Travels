          ...
          <div className="blog-left w-full md:w-4/6 px-4 md:px-12">
            {
              bdetail?.length > 0 &&
              bdetail.map(blo => {
                return   <div key = {blo._id} className="w-full my-11">
             
            
                <img src={`${API}/${blo.blog_image}`}alt={blo.blog_title}className="pic3 h-96" />
            ...
            <input type="text" placeholder="Write Your Comment" className="bg-gray-200 mb-2 me-3"onChange={event =>setComment(event.target.value)} />
            <input type="text" placeholder="Enter Your Name" className="bg-gray-200 mb-2 me-3"onChange={event => setName(event.target.value)} />
            <input type="text" placeholder="Enter Your E-mail" className="bg-gray-200 mb-2"onChange={event => setEmail(event.target.value)} />
