...
const Adminani = () => {
  return (
    ...
    <div className=''>
      ...
      <div className='panda  border-2 border-solid bg-blue-400 md:w-1/3  lg:1/3 sm:w-1/2 flex justify-between items-center w-full py-8 px-4 'style={{height:"24vh"}}>
        ...
        <div className='panda border-2 border-solid bg-blue-400 md:w-1/3 w-full lg:1/3 sm:w-1/2 flex justify-between items-center py-8 px-4 'style={{height:"24vh"}}>
