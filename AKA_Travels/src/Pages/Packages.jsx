            ...
            packages.length > 0 && packages.map(pack => (
                <div className="img-tour w-full md:w-1/2 lg:w-2/5" key={pack._id}>
                   ...
                   <div className='hello flex justify-center items-center'>
                    <h1 className='text-2xl font-bold pb-4'> {pack.title} <i class="fa-solid fa-heart text-red-800 ml-2"></i></h1>
                      </div>

                        <div className=" pb-14">
                            <h1 ><i class="fa-solid fa-location-dot font-bold pe-2 pb-2 text-xl "></i>{pack.product_location}</h1>
                            <h1><i class="fa-regular fa-clock  font-bold pe-2 pb-2 text-xl"></i>{pack.day}</h1>
                            <h1><i class="fa-solid fa-user-group  font-bold pe-2 pb-2 text-xl"></i>{pack.product_people}</h1>
                            <h1><i class="fa-solid fa-signal  font-bold pe-2 text-xl "></i>Easy</h1>
                            <p className='pt-3'>{pack.overview}</p>
                        </div>
                    </div>
