...
const Blogs = () => {
    ...
    const handleClick = () => {
      setClicked(true);
      // Replace 'blogs' with the URL you want to navigate to
  ...
  return (
   ...
   <div className='Blogs flex justify-between pb-56'>
  ...
  <i class="bi bi-arrow-right text-lg"></i>
        ...
        <div className='w-full my-11  overflow-hidden'>
          ...
          <i class="bi bi-chat-right-dots pe-8 mb-2 sm:mb-0">0 comments</i>
                ...
                {/* <button className='font-bold readmore block mx-auto w-1/5 h-12 bg-orange-400 border-2 rounded-lg text-white'>READ MORE <i class="bi bi-arrow-right"></i></button> */}
  ...
  <i class="bi bi-arrow-right text-lg"></i>
        ...
        <div className='flex flex-wrap justify-center'>
               ...
               <a href="blogs" >
                ...
                {/* <button
                    className={`font-bold block w-12 h-8 border-2 hover:bg-${clicked ? 'green' : 'orange'}-400 rounded-md border-${clicked ? 'green' : 'orange'}-600 text-black`}
                    onClick={handleClick}
                >
