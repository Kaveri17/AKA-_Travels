...
const Blogs = () => {
  return (
    <>
      <div className="Blogs flex flex-col sm:flex-row justify-between pb-56">
      {/* <div className="blog-left w-full sm:w-2/6 flex flex-col mt-8 sm:mt-0"> */}
        <div className="blog-left w-full sm:w-full mx-auto  sm:ps-12 mb-8 sm:mb-0">
...
<div className="m-3 flex flex-wrap items-center">
  <i className="bi bi-calendar pe-2 sm:pe-8 mb-2 sm:mb-0">12 December 2023</i>
  <i className="bi bi-eye-fill pe-2 sm:pe-8 mb-2 sm:mb-0">Views(367)</i>
  <div className='border-l-2 ps-4 border-black'>
