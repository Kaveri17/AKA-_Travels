  ...
  return (
    ...
    <footer>
      <div className='px-16  pt-16 -my-20 relative'>
        ...
        <div className="Ready flex  border-2 border-solid border-bg-slate-600 px-8 pt-16 " style={{backgroundColor:"wheat"}}>
      <div className='flex flex-wrap md:w-full lg:w-1/2'>
        ...
        <img src="/Image/clip-removebg-preview.png" alt="" className='w-full ' />
        </div>
     </div>
     </div>
