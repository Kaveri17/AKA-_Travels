      ...
      <div className='flex gap-10 sm:divide-x justify-center sm:w-1/2 mx-auto h-screen items-center sm:flex-row flex-col'> 
        <div className='w-96 h-96'>
          ...
          <div className="grid grid-cols-7 ">
            {days.map((day,index)=>{
              return (
                      <h1 key={index} className='text-center h-14 grid place-content-center text-gray-500 select-none text-sm'>
                        {day}
                      </h1>
                    )
              })}
          ...
          <div className='grid grid-cols-7'>
            {generateDate(today.month(), today.year()).map(
              ({date, currentMonth, today}, index)=>{
                return (
                <div key={index} className='p-2 h-14 border-t grid place-content-center text-sm'>
                  <h1 className={cn(
        ...
        <div className='h-96 w-96 px-5 sm:px-5'>
