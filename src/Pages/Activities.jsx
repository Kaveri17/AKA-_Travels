    ...
    <>
      <div className="wrapper w-10/12 mx-auto">
        ...
        <div className="activity flex flex-wrap justify-between">
          <div className="activity-div overflow-hidden w-full md:w-1/2 lg:w-4/12 py-10 px-2">
            ...
            <h1 className="font-bold text-xl pt-2">
              Boating <span className="totalnotrips text-sm"> (5 Trips) </span>
            </h1>
          </div>
          <div className="activity-div w-full md:w-1/2 lg:w-4/12 py-10 px-2 overflow-hidden">
            <Link to="" className="activity-img relative">
              <img
...
<div className="w-full md:w-1/2 lg:w-4/12 p-5 ">
          <div className="activity-div w-full overflow-hidden ">
            <Link to="" className="activity-img relative">
              <img
                src="\Image\citytour.jpg"
                alt=""
          ...
          <div className="activity-div w-full md:w-1/2 lg:w-4/12 py-10 px-2">
            ...
            <h1 className="font-bold text-xl pt-2">
              Cycling <span className="totalnotrips text-sm"> (5 Trips) </span>
            </h1>
          </div>
          <div className="activity-div w-full md:w-1/2 lg:w-4/12 py-10 px-2">
            <Link to="" className="activity-img relative">
          ...
          <div className="activity-div w-full md:w-1/2 lg:w-4/12 py-10 px-2">
            ...
            <h1 className="font-bold text-xl pt-2">
              Safari <span className="totalnotrips text-sm"> (3 Trips) </span>
            </h1>
          </div>
          <div className="activity-div w-full md:w-1/2 lg:w-4/12 py-10 px-2">
            <Link to="" className="activity-img relative">
            ...
            <h1 className="font-bold text-xl pt-2">
              Rafting <span className="totalnotrips text-sm"> (2 Trips) </span>
            </h1>
          </div>
          <div className="activity-div w-full md:w-1/2 lg:w-4/12 py-10 px-2">
            <Link to="" className="activity-img relative">
          ...
          <div className="activity-div w-full md:w-1/2 lg:w-4/12 py-10 px-2">
            ...
            <h1 className="font-bold text-xl pt-2">
              Sking <span className="totalnotrips text-sm"> (2 Trips) </span>
            </h1>
          </div>
          <div className="activity-div w-full md:w-1/2 lg:w-4/12 py-10 px-2">
            <Link to="" className="activity-img relative">
            ...
            <h1 className="font-bold text-xl pt-2">
              Trekking <span className="totalnotrips text-sm"> (3 Trips) </span>
            </h1>
          </div>
        </div>
      </div>
